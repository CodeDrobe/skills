...
Capture separate home and normal-task snapshots before adapting `assets/theme-starter/codex.css`, `assets/examples/caishen-readable/codex.css`, or `assets/examples/miku-future-beats/codex.css`. Do not assume an example's structural home selectors survived a Codex update.
